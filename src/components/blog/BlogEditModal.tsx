...
import { X, Save, Edit, Upload, Image as ImageIcon } from "lucide-react";
...
const BlogEditModal: React.FC<BlogEditModalProps> = ({
  ...
  const {
    ...
    defaultValues: {
      ...
      isNews: blog.isNews || false,
      isLegal: blog.isLegal || false,
  ...
  const onSubmit: SubmitHandler<EditBlogForm> = async (data) => {
    setSubmitting(true);
    try {
